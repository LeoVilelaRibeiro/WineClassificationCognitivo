...
for i in tqdm(range(0, 200)):
    cmKnn,maeloss,mseloss = KNN.computeExample("winecorreto.csv")
...
for i in tqdm(range(0, 200)):
    cmSVMG,maeloss,mseloss = SVM.computeExample("winecorreto.csv", "rbf", 0)
...
for i in tqdm(range(0, 200)):
    cmNB,maeloss,mseloss = NaiveBayes.computeExample("winecorreto.csv")
