...
Este é um teste do framework com outro arquivo diferente do enviado pela Cognitivo, chamado Titanic, 
foi feito apenas para avaliar o comportamento do código
"""
...
for i in tqdm(range(0, 200)):
    cmKnn,maeloss,mseloss = KNN.computeExample("titanic.csv")
...
for i in tqdm(range(0, 200)):
    cmSVMG,maeloss,mseloss = SVM.computeExample("titanic.csv", "rbf", 0)
...
for i in tqdm(range(0, 200)):
    cmNB,maeloss,mseloss = NaiveBayes.computeExample("titanic.csv")
